...
public class NetFullCombatState : IPacketSerializable
{
	...
	{
		public MegaCrit.Sts2.Core.Saves.Runs.mySerializableRelic relic;
		...
		public void Deserialize(PacketReader reader)
		{
			relic = reader.Read<MegaCrit.Sts2.Core.Saves.Runs.mySerializableRelic>();
		}
	}

	public List<uint> nextChoiceIds = new List<uint>();
	...
	public SerializableRunRngSet Rng { get; private set; } = new SerializableRunRngSet();
