...
public class RunState : IRunState, ICardScope, IPlayerCollection
{
	...
	public RunState? SourceRunState => this;
	...
	public SerializableRelicGrabBag SharedRelicGrabBagSave
	{
		get
		{
			return SharedRelicGrabBag.ToSerializable();
		}
		set
		{
			SharedRelicGrabBag.LoadFromSerializable(value ?? new SerializableRelicGrabBag());
		}
	}
	...
	public List<IMyMapHookListener> HookListeners { get; } = new List<IMyMapHookListener>();

	public CardMultiplayerConstraint CardMultiplayerConstraint => Players.Count <= 1
	...
	public void AddVisitedEvent(EventModel eventModel)
	{
		...
		AddVisitedEvent(eventModel.ModelId);
	}

	public void AddVisitedEvent(ModelId eventId)
	{
