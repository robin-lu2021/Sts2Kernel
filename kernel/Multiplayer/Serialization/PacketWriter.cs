...
using System.Text;
using MegaCrit.Sts2.Core.Headless;
...
public class PacketWriter
{
	...
	public int BytePosition => (BitPosition + 7) / 8;
	...
	public void WriteEnum<T>(T val) where T : struct, Enum
	{
		...
		int bits = (int)Math.Ceiling(Math.Log2(MaxEnumValueCache.Get<T>()) + 1.0);
	...
	{
		int num = (BitPosition + bitsBeingWritten + 7) / 8;
