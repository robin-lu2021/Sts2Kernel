...
public abstract class TemporaryDexterityPower : PowerModel
{
	...
	public override PowerModel InternallyAppliedPowerModel => KernelModelDb.Power<DexterityPower>();
	...
	public override void BeforeApplied(Creature target, decimal amount, Creature? applier, CardModel? cardSource)
	{
		...
		{
			PowerCmd.Apply<DexterityPower>(target, (decimal)Sign * amount, applier, cardSource, silent: true);
		}
	}
	...
	public override void AfterPowerAmountChanged(PowerModel power, decimal amount, Creature? applier, CardModel? cardSource)
	{
		if (!(amount == (decimal)base.Amount) && power == this)
		{
			...
			{
				PowerCmd.Apply<DexterityPower>(base.Owner, (decimal)Sign * amount, applier, cardSource, silent: true);
			}
		}
	}
	...
	public override void AfterTurnEnd(PlayerChoiceContext choiceContext, CombatSide side)
	{
		if (side == base.Owner.Side)
		{
			...
			PowerCmd.Apply<DexterityPower>(base.Owner, -Sign * base.Amount, base.Owner, null);
		}
	}
}
