...
public sealed class MonologuePower : PowerModel
{
	...
	public override void AfterCardPlayed(PlayerChoiceContext context, CardPlay cardPlay)
	{
		...
		{
			PowerCmd.Apply<StrengthPower>(base.Owner, value, base.Owner, null, silent: true);
	...
	public override void AfterTurnEnd(PlayerChoiceContext choiceContext, CombatSide side)
	{
		if (side == base.Owner.Side)
		{
			...
			PowerCmd.Apply<StrengthPower>(base.Owner, -base.DynamicVars["StrengthApplied"].BaseValue, base.Owner, null, silent: true);
		}
	}
}
