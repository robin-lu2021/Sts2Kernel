...
public sealed class BeaconOfHopePower : PowerModel
{
	...
	public override void AfterBlockGained(Creature creature, decimal amount, ValueProp props, CardModel? cardSource)
	{
		...
		{
			CreatureCmd.GainBlock(item, amountToGive, ValueProp.Unpowered, null);
		}
