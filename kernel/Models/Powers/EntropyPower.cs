...
public sealed class EntropyPower : PowerModel
{
	...
	public override void AfterPlayerTurnStart(PlayerChoiceContext choiceContext, Player player)
	{
		...
		List<CardModel> list = (CardSelectCmd.FromHand(choiceContext, player, prefs, null, this).ToList());
		foreach (CardModel item in list)
		{
			CardCmd.TransformToRandom(item, player.RunState.Rng.CombatCardSelection);
		}
	}
}
