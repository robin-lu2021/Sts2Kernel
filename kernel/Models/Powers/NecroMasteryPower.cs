...
public sealed class NecroMasteryPower : PowerModel
{
	...
	public override void AfterCurrentHpChanged(Creature creature, decimal delta)
	{
		...
		{
			CreatureCmd.Damage(new ThrowingPlayerChoiceContext(), creature.CombatState.HittableEnemies, -delta * (decimal)base.Amount, ValueProp.Unblockable | ValueProp.Unpowered, base.Owner, null);
		}
	}
}
