...
public sealed class BeetleJuice : global::MegaCrit.Sts2.Core.PotionModel
{
	...
	protected override void OnUse(PlayerChoiceContext? choiceContext, Creature? target)
	{
		...
		PowerCmd.Apply<ShrinkPower>(target, base.DynamicVars.Repeat.BaseValue, base.Owner.Creature, null);
	}
}
