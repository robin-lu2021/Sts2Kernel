...
public sealed class ShipInABottle : global::MegaCrit.Sts2.Core.PotionModel
{
	...
	protected override void OnUse(PlayerChoiceContext? choiceContext, Creature? target)
	{
		...
		CreatureCmd.GainBlock(target, base.DynamicVars.Block, null);
		PowerCmd.Apply<BlockNextTurnPower>(target, base.DynamicVars.Block.IntValue, base.Owner.Creature, null);
	}
}
