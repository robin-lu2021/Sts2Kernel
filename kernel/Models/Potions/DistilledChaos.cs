...
public sealed class DistilledChaos : global::MegaCrit.Sts2.Core.PotionModel
{
	...
	{
		CardPileCmd.AutoPlayFromDrawPile(choiceContext, base.Owner, base.DynamicVars.Repeat.IntValue, CardPilePosition.Top, forceExhaust: false);
	}
}
