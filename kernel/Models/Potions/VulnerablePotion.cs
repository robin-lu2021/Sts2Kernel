...
public sealed class VulnerablePotion : global::MegaCrit.Sts2.Core.PotionModel
{
	...
	protected override void OnUse(PlayerChoiceContext? choiceContext, Creature? target)
	{
		...
		PowerCmd.Apply<VulnerablePower>(target, base.DynamicVars.Vulnerable.BaseValue, base.Owner.Creature, null);
	}
}
