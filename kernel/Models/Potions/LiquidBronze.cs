...
public sealed class LiquidBronze : global::MegaCrit.Sts2.Core.PotionModel
{
	...
	protected override void OnUse(PlayerChoiceContext? choiceContext, Creature? target)
	{
		...
		PowerCmd.Apply<ThornsPower>(target, base.DynamicVars["ThornsPower"].BaseValue, base.Owner.Creature, null);
	}
}
