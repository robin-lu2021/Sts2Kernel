...
public sealed class GigantificationPotion : global::MegaCrit.Sts2.Core.PotionModel
{
	...
	protected override void OnUse(PlayerChoiceContext? choiceContext, Creature? target)
	{
		...
		PowerCmd.Apply<GigantificationPower>(target, base.DynamicVars["GigantificationPower"].BaseValue, base.Owner.Creature, null);
	}
}
