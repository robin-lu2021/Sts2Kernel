...
public sealed class HeartOfIron : global::MegaCrit.Sts2.Core.PotionModel
{
	...
	protected override void OnUse(PlayerChoiceContext? choiceContext, Creature? target)
	{
		...
		PowerCmd.Apply<PlatingPower>(target, base.DynamicVars["PlatingPower"].BaseValue, base.Owner.Creature, null);
	}
}
