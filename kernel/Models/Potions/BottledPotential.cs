...
public sealed class BottledPotential : global::MegaCrit.Sts2.Core.PotionModel
{
	...
	protected override void OnUse(PlayerChoiceContext? choiceContext, Creature? target)
	{
		...
		CardPileCmd.Add(PileType.Hand.GetPile(target.Player).Cards, PileType.Draw);
		CardPileCmd.Shuffle(choiceContext, target.Player);
