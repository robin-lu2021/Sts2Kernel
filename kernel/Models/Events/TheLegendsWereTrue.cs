...
public sealed class TheLegendsWereTrue : EventModel
{
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		...
		{
			new EventOption(this, NabTheMap, "THE_LEGENDS_WERE_TRUE.pages.INITIAL.options.NAB_THE_MAP", KernelHoverTipFactory.FromCardWithCardHoverTips<SpoilsMap>()),
