...
public sealed class ThisOrThat : EventModel
{
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[3]
	{
		new HpLossVar(6m),
		new GoldVar(0),
		new StringVar("Curse", KernelModelDb.Card<Clumsy>().Title)
	});
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		return new global::_003C_003Ez__ReadOnlyArray<EventOption>(new EventOption[2]
		{
			...
			new EventOption(this, Ornate, "THIS_OR_THAT.pages.INITIAL.options.ORNATE", KernelHoverTipFactory.FromCardWithCardHoverTips<Clumsy>())
		});
	}
	...
	private void Ornate()
	{
		...
		CardPileCmd.AddCurseToDeck<Clumsy>(base.Owner);
