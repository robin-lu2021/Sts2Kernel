...
public sealed class SapphireSeed : EventModel
{
	...
	private void Plant()
	{
		...
		CardModel? cardModel = CardSelectCmd.FromDeckForEnchantment(prefs: new CardSelectorPrefs(CardSelectorPrefs.EnchantSelectionPrompt, 1), cards: cards, enchantment: sown, amount: 1).FirstOrDefault();
		if (cardModel != null)
		{
