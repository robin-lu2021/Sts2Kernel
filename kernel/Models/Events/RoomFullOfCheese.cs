...
public sealed class RoomFullOfCheese : EventModel
{
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		return new global::_003C_003Ez__ReadOnlyArray<EventOption>(new EventOption[2]
		{
			...
			new EventOption(this, Search, "ROOM_FULL_OF_CHEESE.pages.INITIAL.options.SEARCH", KernelHoverTipFactory.FromRelic<ChosenCheese>().ThatDoesDamage(base.DynamicVars.Damage.BaseValue))
		});
	}
	...
	private void Gorge()
	{
		...
		foreach (CardModel item in CardSelectCmd.FromSimpleGridForRewards(prefs: new CardSelectorPrefs(L10NLookup("ROOM_FULL_OF_CHEESE.pages.GORGE.selectionScreenPrompt"), 2), context: new BlockingPlayerChoiceContext(), cards: cards, player: owner))
		{
			CardPileCmd.Add(item, PileType.Deck);
		}
	...
	private void Search()
	{
		...
		RelicCmd.Obtain<ChosenCheese>(base.Owner);
