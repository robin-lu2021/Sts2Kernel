...
public sealed class CrystalSphere : EventModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[4]
	{
		...
		new StringVar("CurseTitle", KernelModelDb.Card<Debt>().Title)
	});
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		return new global::_003C_003Ez__ReadOnlyArray<EventOption>(new EventOption[2]
		{
			...
			new EventOption(this, PaymentPlan, "CRYSTAL_SPHERE.pages.INITIAL.options.PAYMENT_PLAN", KernelHoverTipFactory.FromCardWithCardHoverTips<Debt>())
		});
	}

	private void UncoverFuture()
	{
		PlayerCmd.LoseGold(base.DynamicVars["UncoverFutureCost"].BaseValue, base.Owner, GoldLossType.Spent);
		CrystalSphereMinigame crystalSphereMinigame = new CrystalSphereMinigame(base.Owner, base.Rng, 3);
		crystalSphereMinigame.PlayMinigame();
		SetEventFinished(L10NLookup("CRYSTAL_SPHERE.pages.FINISH.description"));
	}

	private void PaymentPlan()
	{
		CardPileCmd.AddCurseToDeck<Debt>(base.Owner);
