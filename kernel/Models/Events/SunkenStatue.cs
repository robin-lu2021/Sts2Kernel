...
public sealed class SunkenStatue : EventModel
{
	...
	{
		new StringVar("Relic", KernelModelDb.Relic<SwordOfStone>().Title.GetFormattedText()),
		new GoldVar(111),
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		...
		{
			new EventOption(this, GrabSword, "SUNKEN_STATUE.pages.INITIAL.options.GRAB_SWORD", KernelHoverTipFactory.FromRelic<SwordOfStone>()),
