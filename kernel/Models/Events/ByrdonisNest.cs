...
public sealed class ByrdonisNest : EventModel
{
	...
	{
		new MaxHpVar(7m),
		new StringVar("Card", KernelModelDb.Card<ByrdonisEgg>().Title)
	});
	...
	protected override IReadOnlyList<EventOption> GenerateInitialOptions()
	{
		return new global::_003C_003Ez__ReadOnlyArray<EventOption>(new EventOption[2]
		{
			...
			new EventOption(this, Take, "BYRDONIS_NEST.pages.INITIAL.options.TAKE", KernelHoverTipFactory.FromCardWithCardHoverTips<ByrdonisEgg>())
		});
	}
