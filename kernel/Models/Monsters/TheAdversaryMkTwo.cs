...
public sealed class TheAdversaryMkTwo : MonsterModel
{
	...
	protected override MonsterMoveStateMachine GenerateMoveStateMachine()
	{
		...
		MoveState moveState = new MoveState("BASH_MOVE", SyncMove(BashMove), new SingleAttackIntent(BashDamage));
	...
	private void BashMove(IReadOnlyList<Creature> targets)
	{
		DamageCmd.Attack(BashDamage).FromMonster(this)
			.Execute(null);
	}
