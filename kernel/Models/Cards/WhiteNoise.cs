...
public sealed class WhiteNoise : CardModel
{
	...
	{
		CardModel cardModel = KernelCardFactoryExtensions.GetDistinctForCombat(base.Owner, from c in base.Owner.Character.CardPool.GetUnlockedCards(base.Owner.UnlockState, base.Owner.RunState.CardMultiplayerConstraint)
