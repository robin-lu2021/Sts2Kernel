...
public sealed class ThinkingAhead : CardModel
{
	...
	protected override void OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		CardModel cardModel = (CardSelectCmd.FromHand(prefs: new CardSelectorPrefs(base.SelectionScreenPrompt, 1), context: choiceContext, player: base.Owner, filter: null, source: this).FirstOrDefault());
		if (cardModel != null)
		{
			CardPileCmd.Add(cardModel, PileType.Draw, CardPilePosition.Top);
		}
	}
