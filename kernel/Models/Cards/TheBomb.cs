...
public sealed class TheBomb : CardModel
{
	...
	{
		TheBombPower power = PowerCmd.Apply<TheBombPower>(base.Owner.Creature, base.DynamicVars["Turns"].BaseValue, base.Owner.Creature, this);
		power.SetDamage(base.DynamicVars["BombDamage"].BaseValue);
	}
