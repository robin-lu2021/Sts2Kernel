...
public sealed class Soul : CardModel
{
	...
	public static IEnumerable<Soul> CreateInHand(Player owner, int amount, CombatState combatState)
	{
		IEnumerable<Soul> souls = Create(owner, amount, combatState);
		CardPileCmd.AddGeneratedCardsToCombat(souls, PileType.Hand, addedByPlayer: true);
		return souls;
	}
