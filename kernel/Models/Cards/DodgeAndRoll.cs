...
public sealed class DodgeAndRoll : CardModel
{
	...
	{
		decimal amount = CreatureCmd.GainBlock(base.Owner.Creature, base.DynamicVars.Block, cardPlay);
		PowerCmd.Apply<BlockNextTurnPower>(base.Owner.Creature, amount, base.Owner.Creature, this);
	}
