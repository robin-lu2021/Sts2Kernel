...
public sealed class DualWield : CardModel
{
	...
	{
		CardModel selection = (CardSelectCmd.FromHand(prefs: new CardSelectorPrefs(base.SelectionScreenPrompt, 1), context: choiceContext, player: base.Owner, filter: delegate(CardModel c)
		{
