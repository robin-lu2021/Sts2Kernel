...
public sealed class PhotonCut : CardModel
{
	...
	protected override void OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		CardPileCmd.Add(CardSelectCmd.FromHand(prefs: new CardSelectorPrefs(base.SelectionScreenPrompt, base.DynamicVars["PutBack"].IntValue), context: choiceContext, player: base.Owner, filter: null, source: this), PileType.Draw, CardPilePosition.Top);
	}
