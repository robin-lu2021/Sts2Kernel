...
public sealed class TrueGrit : CardModel
{
	...
	protected override void OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		if (base.IsUpgraded)
		{
			CardModel cardModel = (CardSelectCmd.FromHand(prefs: new CardSelectorPrefs(CardSelectorPrefs.ExhaustSelectionPrompt, 1), context: choiceContext, player: base.Owner, filter: null, source: this).FirstOrDefault());
			if (cardModel != null)
			{
		...
		if (cardModel2 != null)
		{
			CardCmd.Exhaust(choiceContext, cardModel2);
		}
	}
