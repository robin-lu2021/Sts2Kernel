...
public sealed class JackOfAllTrades : CardModel
{
	...
	{
		IEnumerable<CardModel> distinctForCombat = KernelCardFactoryExtensions.GetDistinctForCombat(base.Owner, from c in ModelDb.CardPool<ColorlessCardPool>().GetUnlockedCards(base.Owner.UnlockState, base.Owner.RunState.CardMultiplayerConstraint)
