...
public sealed class SeekerStrike : CardModel
{
	...
	protected override void OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		CardModel? cardModel = CardSelectCmd.FromSimpleGrid(choiceContext, source.Take(base.DynamicVars.Cards.IntValue).ToList(), base.Owner, new CardSelectorPrefs(base.SelectionScreenPrompt, 1)).FirstOrDefault();
		if (cardModel != null)
		{
