...
public sealed class Omnislice : CardModel
{
	...
	protected override void OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		using AttackContext context = AttackCommand.CreateContextAsync(base.CombatState, this);
		List<DamageResult> list = (CreatureCmd.Damage(choiceContext, cardPlay.Target, base.DynamicVars.Damage.BaseValue, ValueProp.Move, this).ToList());
		context.AddHit(list);
		...
		if (damageResult != null)
		{
			...
			if (list2.Count != 0)
			{
				...
				attackContext.AddHit(CreatureCmd.Damage(choiceContext, list2, damageResult.TotalDamage + damageResult.OverkillDamage, ValueProp.Unpowered | ValueProp.Move, base.Owner.Creature, this));
			}
		}
	}
