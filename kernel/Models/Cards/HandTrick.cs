...
public sealed class HandTrick : CardModel
{
	...
	protected override void OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		CardModel cardModel = (CardSelectCmd.FromHand(prefs: new CardSelectorPrefs(base.SelectionScreenPrompt, 1), context: choiceContext, player: base.Owner, filter: (CardModel card) => card.Type == CardType.Skill && !card.IsSlyThisTurn, source: this).FirstOrDefault());
		if (cardModel != null)
		{
