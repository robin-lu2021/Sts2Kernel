...
public sealed class Spinner : CardModel
{
	...
	protected override void OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		if (base.IsUpgraded)
		{
			OrbCmd.Channel<GlassOrb>(new ThrowingPlayerChoiceContext(), base.Owner);
		}
		PowerCmd.Apply<SpinnerPower>(base.Owner.Creature, base.DynamicVars["SpinnerPower"].BaseValue, base.Owner.Creature, this);
	}
}
