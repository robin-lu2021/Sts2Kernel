...
public sealed class EchoingSlash : CardModel
{
	...
	{
		using AttackContext attackContext = AttackCommand.CreateContextAsync(base.CombatState, this);
		int attackCount = 1;
		while (attackCount > 0)
		{
			attackCount--;
			IEnumerable<DamageResult> enumerable = CreatureCmd.Damage(choiceContext, base.CombatState.HittableEnemies, base.DynamicVars.Damage, base.Owner.Creature, this);
