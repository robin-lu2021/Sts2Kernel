...
public sealed class ExpectAFight : CardModel
{
	...
	{
		PlayerCmd.GainEnergy(((CalculatedVar)base.DynamicVars["CalculatedEnergy"]).Calculate(cardPlay.Target), base.Owner);
		PowerCmd.Apply<NoEnergyGainPower>(base.Owner.Creature, 1m, base.Owner.Creature, this);
	}
