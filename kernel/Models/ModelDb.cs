...
public static class ModelDb
{
	...
	{
		Type[] allAbstractModelSubtypes = AllAbstractModelSubtypes;
		foreach (Type type in allAbstractModelSubtypes.Distinct())
		{
	...
	{
		Type categoryType = GetCategoryType(type);
		if (categoryType == typeof(CardModel))
		{
			return "CARD";
		}
		...
		if (categoryType == typeof(MonsterModel))
		{
			return "MONSTER";
		}
		if (categoryType == typeof(PotionModel))
		{
			return "POTION";
		}
		if (categoryType == typeof(PowerModel))
		{
			return "POWER";
		}
		if (categoryType == typeof(RelicModel))
		{
			return "RELIC";
		}
		return ModelId.SlugifyCategory(categoryType.Name);
	}
