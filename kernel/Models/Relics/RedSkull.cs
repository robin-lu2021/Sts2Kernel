...
public sealed class RedSkull : RelicModel
{
	...
	public override void AfterCurrentHpChanged(Creature creature, decimal _)
	{
	...
	private void ModifyStrengthIfNecessary()
	{
		...
		if (flag && StrengthApplied)
		{
			...
			PowerCmd.Apply<StrengthPower>(creature, -baseValue, creature, null);
			StrengthApplied = false;
		}
