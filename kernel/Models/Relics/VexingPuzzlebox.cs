...
public sealed class VexingPuzzlebox : RelicModel
{
	...
	public override void AfterPlayerTurnStart(PlayerChoiceContext choiceContext, Player player)
	{
		if (player == base.Owner && base.Owner.Creature.CombatState.RoundNumber == 1)
		{
			...
			CardModel cardModel = KernelCardFactoryExtensions.GetDistinctForCombat(base.Owner, base.Owner.Character.CardPool.GetUnlockedCards(base.Owner.UnlockState, base.Owner.RunState.CardMultiplayerConstraint), 1, base.Owner.RunState.Rng.CombatCardGeneration).First();
