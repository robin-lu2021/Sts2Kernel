...
public sealed class Cauldron : RelicModel
{
	...
	{
		KernelModelDb.Potion<FlexPotion>(),
		KernelModelDb.Potion<WeakPotion>(),
		KernelModelDb.Potion<VulnerablePotion>(),
		KernelModelDb.Potion<StrengthPotion>(),
		KernelModelDb.Potion<DexterityPotion>()
	};
