...
public sealed class PhylacteryUnbound : RelicModel
{
	...
	{
		OstyCmd.Summon(new ThrowingPlayerChoiceContext(), base.Owner, base.DynamicVars["StartOfCombat"].BaseValue, this);
	}
	...
	public override void AfterSideTurnStart(CombatSide side, CombatState combatState)
	{
		...
		{
			OstyCmd.Summon(new ThrowingPlayerChoiceContext(), base.Owner, base.DynamicVars["StartOfTurn"].BaseValue, this);
		}
	}
}