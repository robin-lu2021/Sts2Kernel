...
public sealed class DustyTome : RelicModel
{
	...
	public ModelId? AncientCard
	{
		...
		set
		{
			...
			if (_ancientCard != null)
			{
				...
				_extraHoverTips = cardModel.HoverTips.Concat(new global::_003C_003Ez__ReadOnlySingleElementList<IHoverTip>(KernelHoverTipFactory.FromCard(cardModel, upgrade: true)));
	...
	public override void AfterObtained()
	{
		...
		CardCmd.PreviewCardPileAdd(CardPileCmd.Add(card, PileType.Deck), 2f);
	}
}