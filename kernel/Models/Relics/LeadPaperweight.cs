...
public sealed class LeadPaperweight : RelicModel
{
	...
	public override void AfterObtained()
	{
		...
		CardModel chosenCard = CardSelectCmd.FromChooseACardScreen(new BlockingPlayerChoiceContext(), options2, base.Owner, canSkip: true);
		if (chosenCard != null)
		{
			CardCmd.PreviewCardPileAdd(CardPileCmd.Add(chosenCard, PileType.Deck));
		}
