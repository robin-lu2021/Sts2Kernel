...
public sealed class LargeCapsule : RelicModel
{
	...
	public override void AfterObtained()
	{
		...
		list2.Add(CardPileCmd.Add(base.Owner.RunState.CreateCard(GetStrikeForCharacter(base.Owner.Character), base.Owner), PileType.Deck));
		List<CardPileAddResult> list3 = list;
		list3.Add(CardPileCmd.Add(base.Owner.RunState.CreateCard(GetDefendForCharacter(base.Owner.Character), base.Owner), PileType.Deck));
