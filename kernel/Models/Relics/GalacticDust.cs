...
public sealed class GalacticDust : RelicModel
{
	...
	public override void AfterStarsSpent(int amount, Player spender)
	{
		if (spender == base.Owner)
		{
			...
			{
				DoActivateVisuals();
				int triggerCount = StarsSpent / base.DynamicVars.Stars.IntValue;
				CreatureCmd.GainBlock(base.Owner.Creature, triggerCount * base.DynamicVars.Block.IntValue, ValueProp.Unpowered, null);
