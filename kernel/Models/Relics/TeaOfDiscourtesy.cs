...
public sealed class TeaOfDiscourtesy : RelicModel
{
	...
	public override void BeforeCombatStart()
	{
		if (CombatsLeft > 0)
		{
			CardPileCmd.AddToCombatAndPreview<Dazed>(base.Owner.Creature, PileType.Draw, base.DynamicVars["DazedCount"].IntValue, addedByPlayer: true, CardPilePosition.Random);
			CombatsLeft--;
