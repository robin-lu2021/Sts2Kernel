...
public sealed class PaelsGrowth : RelicModel
{
	...
	{
		foreach (CardModel item in CardSelectCmd.FromDeckForEnchantment(prefs: new CardSelectorPrefs(CardSelectorPrefs.EnchantSelectionPrompt, 1), player: base.Owner, enchantment: ModelDb.Enchantment<Clone>(), amount: 1))
		{
