...
public class CombatHistory
{
	...
	public void PowerReceived(CombatState combatState, Creature receiver, PowerModel power, decimal amount, Creature? applier)
	{
		Add(new PowerReceivedEntry(receiver, power, amount, applier, combatState.RoundNumber, combatState.CurrentSide, this));
	}
