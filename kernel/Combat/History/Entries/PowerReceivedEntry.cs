...
public class PowerReceivedEntry : CombatHistoryEntry
{
	...
	public PowerReceivedEntry(Creature receiver, PowerModel power, decimal amount, Creature? applier, int roundNumber, CombatSide currentSide, CombatHistory history)
