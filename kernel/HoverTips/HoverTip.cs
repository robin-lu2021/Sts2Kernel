...
public record struct HoverTip : IHoverTip
{
	...
	public HoverTip(LocString description, string? icon = null)
	{
		Title = null;
		IsSmart = false;
		IsDebuff = false;
	...
	public HoverTip(LocString title, LocString description, string? icon = null)
	{
		IsSmart = false;
		IsDebuff = false;
		IsInstanced = false;
	...
	public HoverTip(LocString title, string description, string? icon = null)
	{
		IsSmart = false;
		IsDebuff = false;
		IsInstanced = false;
