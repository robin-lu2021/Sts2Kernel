...
public abstract class AbstractRoom
{
	...
	public void Enter(IRunState? runState, bool isRestoringRoomStackBase)
	{
		Id = runState?.GetAndIncrementNextRoomId();
		EnterInternal(runState, isRestoringRoomStackBase);
	}
	
	public abstract void EnterInternal(IRunState? runState, bool isRestoringRoomStackBase);

	public abstract void Exit(IRunState? runState);

	public abstract void Resume(AbstractRoom exitedRoom, IRunState? runState);
